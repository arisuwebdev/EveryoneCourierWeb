...
export default function AssignedJobView() {
  ...
  const fetchJobDetails = useCallback(async () => {
    try {
      ...
      toast.error(
        err.response?.data?.msg || "Failed to load job."
      );
    } finally {
      setLoading(false);
    }
  ...
  const fetchComplaint = useCallback(async () => {
    ...
    try {
      ...
      if (response?.status === 1) {
        setComplaint(
          response?.payload?.complaint || null
        );
      } else {
        setComplaint(null);
      }
  ...
  const handleConfirmDelivery = async () => {
    ...
    try {
      ...
      const res = await confirmJobCompleteService(
        job.id,
        token
      );
      ...
      if (res.status === 1) {
        toast.success(
          res.msg || "Delivery confirmed successfully."
        );
        ...
        toast.error(
          res.msg || "Failed to confirm delivery."
        );
      }
    } catch (err) {
      toast.error(
  ...
  const handleRemoveJob = async () => {
    ...
    try {
      ...
      const res = await removeJobService(
        job.id,
        token
      );
      ...
      if (res.status === 1) {
        toast.success(
          res.msg || "Job removed successfully."
        );

        navigate(-1);
      } else {
        toast.error(
          res.msg || "Failed to remove job."
        );
      }
    } catch (err) {
      toast.error(
  ...
  const PostupdateJobStatus = async (
    newStatus
  ) => {
    try {
      setIsUpdating(true);
              ...
              <CardContent className="space-y-6">
                                  ...
                                  <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                      ...
                                      <p className="mt-1 text-sm text-emerald-700">
                                        The courier has marked this job
                                        as delivered. Please confirm that
                                ...
                                <div className="p-5">
                                  ...
                                  <div className="mb-4 rounded-xl bg-slate-50 p-4">
                                    ...
                                    <p className="mt-1 text-xs text-slate-500">
                                      ...
                                      have received the parcel successfully.
                                    </p>
                                ...
                                <div className="flex items-start gap-3">
                                  ...
                                  <div>
                                    ...
                                    <p className="mt-1 text-sm text-red-700">
                                      ...
                                      parcel or delivery, you can raise
                                      a complaint.
                                    </p>
                                  </div>
                                </div>
                                  ...
                                  <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                      ...
                                      <p className="mt-1 text-xs text-red-600">
                                        ...
                                        or any other delivery problem to our team.
                                      </p>
                                    </div>
                                  </div>
                ...
                {isCustomer &&
                  ...
                  <DeliveredSection
                    ...
                    customerRating={
                      job.customer_given_rating
                    }
                    customerReview={
                      job.customer_given_review
                    }
                    courierHasReviewed={
                      courierHasReviewed
                    }
                    courierRating={
                      job?.courier_given_rating
                    }
                    courierReview={
                      job?.courier_given_review
                    }
                    onReviewed={
                      fetchJobDetails
                    }
