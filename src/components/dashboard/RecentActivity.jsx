// -------------------------------------------------- new changes add from client feedback --------------- 
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              {activities.slice(0, 5).map((activity) => {
                const isJobActivity = !!activity.job_id && activity.activity_type !== "JOB_APPLIED";
                ...
                const handleActivityClick = () => {
                  ...
                  navigate(
                    `/my-jobs/${activity.job_id}/applicants?type=postings`,
                  );
                };
                ...
                return (
                  <div
                    key={activity.id}
                   onClick={isJobActivity ? handleActivityClick : undefined}
                    className={`flex items-start gap-3 p-3 border rounded-lg transition ${
                      isJobActivity
                        ? "cursor-pointer hover:bg-slate-50 hover:border-blue-300"
                        : ""
                    }`}
                  >
                    {/* Activity dot */}
                    ...
                    {/* Arrow for clickable job activities */}
                    {isJobActivity && (
