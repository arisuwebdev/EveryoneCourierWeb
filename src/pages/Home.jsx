        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 md:py-32">
          <div className="text-center">
                ...
                <div className="relative flex items-center gap-4 bg-white/10 backdrop-blur-md border border-white/30 px-8 py-5 rounded-3xl shadow-2xl">
                  ...
                  <div className="text-left">
                    <div className="text-2xl md:text-3xl font-black leading-none tracking-tight">
                      <span className="bg-gradient-to-r from-pink-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent">Everyone's</span>
                    </div>
                    <div className="text-2xl md:text-3xl font-black leading-none tracking-tight">
                      <span className="text-gray-800">a </span>
                      <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">Courier</span>
                    </div>
                    <div className="text-xs font-semibold text-purple-500 tracking-widest uppercase mt-1">Peer-to-Peer Delivery</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              Everyone's a
              <span className="bg-gradient-to-r from-pink-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent"> Courier</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Connect people who need deliveries with travelers already heading that way. 
              <strong> Save money, earn extra income, help your community.</strong>
            </p>
            ...
            <Card className="relative overflow-hidden border-2 border-pink-200 shadow-xl hover:shadow-2xl hover:shadow-pink-500/50 transition-all duration-300">
              ...
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">Need Something Delivered?</h3>
                </div>
                
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg">1</div>
                    <div>
                      <p className="font-semibold">Post Your Job</p>
                      <p className="text-gray-600 text-sm">Describe what needs delivering and set your price</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg">2</div>
                    <div>
                      <p className="font-semibold">Choose Your Courier</p>
                      <p className="text-gray-600 text-sm">Review applications from verified travelers</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg">3</div>
                    <div>
                      <p className="font-semibold">Track & Receive</p>
                      <p className="text-gray-600 text-sm">Follow your delivery and pay when complete</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="relative overflow-hidden border-2 border-green-200 shadow-xl hover:shadow-2xl hover:shadow-green-500/50 transition-all duration-300">
              ...
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">Traveling Somewhere?</h3>
                </div>
                
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-gradient-to-r from-green-500 to-teal-500 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg">1</div>
                    <div>
                      <p className="font-semibold">Browse Jobs</p>
                      <p className="text-gray-600 text-sm">Find deliveries along your route</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-gradient-to-r from-green-500 to-teal-500 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg">2</div>
                    <div>
                      <p className="font-semibold">Apply & Get Selected</p>
                      <p className="text-gray-600 text-sm">Show you're the right person for the job</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-gradient-to-r from-green-500 to-teal-500 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg">3</div>
                    <div>
                      <p className="font-semibold">Deliver & Earn</p>
                      <p className="text-gray-600 text-sm">Complete delivery and get paid instantly</p>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center p-8 border-0 shadow-xl bg-white/90 backdrop-blur-sm hover:shadow-2xl hover:shadow-yellow-500/50 transition-all duration-300">
              ...
              <p className="text-gray-600">
                Pay less than traditional delivery services while supporting your community
              </p>
            </Card>
            ...
            <Card className="text-center p-8 border-0 shadow-xl bg-white/90 backdrop-blur-sm hover:shadow-2xl hover:shadow-purple-500/50 transition-all duration-300">
              ...
              <p className="text-gray-600">
                ID verification, secure payments, and user ratings keep everyone protected
              </p>
            </Card>
          </div>
        </div>
